...
const values = [
  {
    ...
    description: "We build lasting relationships through honest communication and clear processes.",
  },
  {
    icon: Sparkles,
    title: "Premium Quality",
    description: "Every item is carefully inspected to ensure it meets our high standards.",
  },
  {
    icon: TrendingUp,
    title: "Reseller Success",
    description: "We're invested in your growth — your success is our success.",
  },
  {
    icon: Leaf,
    title: "Sustainability",
    description: "Giving quality clothing a second life through responsible sourcing.",
  },
];
...
const AboutPage = () => {
  return (
    <div className="w-full overflow-hidden bg-background">
      <section className="relative w-full min-h-[50vh] sm:min-h-[60vh] lg:min-h-[70vh] flex items-center justify-center">
        <Image
          src="/men.png"
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          <p className="text-sm sm:text-base lg:text-xl text-gray-300 max-w-2xl mx-auto font-light leading-relaxed">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4 mt-6 sm:mt-8">
            ...
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 border border-white/30 text-white font-semibold px-6 sm:px-8 py-3 sm:py-3.5 rounded-lg hover:bg-white/10 transition-all duration-200 text-sm sm:text-base"
            >
              Contact Us
            </Link>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-gradient-to-br from-gray-900 via-gray-900 to-blue-900 rounded-3xl p-8 sm:p-12 lg:p-16 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-300 max-w-xl mx-auto mb-6 sm:mb-8 text-sm sm:text-base lg:text-lg">
